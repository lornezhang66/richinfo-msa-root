...
public class HttpUtil {
	...
	public static String get(String url, Map<String, String> queryParas, Map<String, String> headers, String charset) {
		log.info("send wechat get url:" + url);
		log.info("send wechat params:" + JSON.toJSONString(queryParas));
	...
	public static String post(String url, Map<String, String> queryParas, String data, Map<String, String> headers, String charset) {
		...
		log.info("send params:" + JSON.toJSONString(queryParas));
	...
	private static String readResponseString(HttpURLConnection conn, String charset) {
		...
		try {
			...
			try {
				...
				log.error("response msg: " + conn.getResponseMessage());
	...
	public static void main(String[] args) {
		System.out.println(post("https://api.zhaopin.com/v1/apply/fit?access_token=fc352701e1e949dc8b809172d8e03dcd", "jobResumeIds=368058501"));
	}
}
